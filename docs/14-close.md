![Close](assets/14-close.png){ .hero }
...
<!--
Speaker note (~2 min): This is the landing. Don't rush it. Recap the five
bullets, slow down on the last one, and end on the human-holding-the-wheel
image. Leave time for one or two questions.
-->
