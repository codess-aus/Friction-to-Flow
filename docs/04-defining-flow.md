![Defining Flow](assets/4-defining-flow.png){ .hero }
...
<!--
Speaker note (~2 min): Slow down here. Flow is the central metaphor of the
talk, make sure the room owns the definition before moving on. Emphasise:
